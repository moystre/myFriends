...
public class FriendsDbAdapter implements IFriendsDbAdapter {
    ...
    FriendsSQLiteDbSchema dbSchema;
    SQLiteDatabase db;
    ...
    {
        dbSchema = new FriendsSQLiteDbSchema(context);
    ...
    static class FriendsSQLiteDbSchema extends SQLiteOpenHelper {
...
//                + PICTURE + " VARCHAR(255));";
        ...
        public FriendsSQLiteDbSchema(Context context) {
